...
export class FakeBackendInterceptor implements HttpInterceptor {
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function authenticate() {
            ...
            if (!user) return error('Username ou mot de passe est incorrect');
            return ok({
                ...basicDetails(user),
        ...
        function register() {
            ...
            if (users.find((x: { username: any; }) => x.username === user.username)) {
                return error('Username "' + user.username + '" est déjà prit')
            }
        ...
        function ok(body?: { token?: string; id: any; username: any; firstName: any; lastName: any; email: any; } | undefined) {
        ...
        function basicDetails(user: { id: any; username: any; firstName: any; lastName: any; email: any; }) {
